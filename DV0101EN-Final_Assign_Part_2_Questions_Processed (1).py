...
app.layout = html.Div([
    ...
    html.Div(id='output-container', className='chat-grid', style={'display': 'flex'}),])
])
...
@app.callback(
    ...
    [Input(component_id='dropdown_statistics', component_property='selected_statistics'), Input(component_id='dropdown_statistics', component_property='selected_statistics')])


def update_output_container(Yearly_data, recession_data):
